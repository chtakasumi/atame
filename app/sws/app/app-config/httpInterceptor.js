"use strict";
var httpInterceptor =  angular.module('httpInterceptor',['toaster']);

httpInterceptor.factory('httpInterceptor', ['$q','toaster','$rootScope','$location',
				...
				return {
					...
					responseError : function(rejection) {                      
						...
						default:
							toaster.popError('Erro!',
									'Ocorreu um erro inesperado. Informe o Suporte Técnico. CODE: '
											+ rejection.status);
						}
...
httpInterceptor.config(['$httpProvider',
