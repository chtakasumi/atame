...
app.run(['$rootScope', 'helper', 'userService', 'anonymous', '$modal', '$timeout', '$injector', 'servico',
   function ($rootScope, helper, userService, anonymous, $modal, $timeout, $injector, servico) {
      ...
      $rootScope.confirm = function (titulo, funcao) {
         ...
         $modal.open({
            ...
            controller: function ($scope, $modalInstance, param) {
...
app.service("servico", ['helper', function (helper) {
      return {
