var app = angular.module('app', [ 'toaster', 'rotas', 'httpInterceptor','api','ui.utils.masks','customFilter']);

app.run(['$rootScope','helper','userService','anonymous','$modal','$timeout','permissao',function($rootScope,helper,userService,anonymous,$modal,$timeout,permissao) {

	$rootScope.user={Nivel:''};
	$rootScope.consultarSessao=0;
	var temposessao =5000;
	...
	$rootScope.sistema = {
		...
		saudacao:"Bem vindo",
		rodape1 :  "SISCO - Sistema de Controle de Orçamento",
		rodape2 : "@Todos os direitos Reservados",
		version:"Versão 1.0.0",
		autor:"vendas@simwebsite.com.br",
		menu:false,		
		tela:{titulo:'',legenda:''}
	};	
