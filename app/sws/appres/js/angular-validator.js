(function() {
  ...
  angular.module('validator.directive', ['validator.provider', 'pascalprecht.translate'])
...
(function () {
	...
	angular.module('validator.provider', [])
		.provider('$validator', function () {
			var $injector, $q, $timeout, $translate;
			$injector = null;
			$q = null;
			$timeout = null;
			$translate = null;
				...
				return function (value, scope, element, attrs) {
					...
					while (parent.length !== 0) {
						if (parent.hasClass('form-group')) {
							...
							$label = $("<label class='label-group control-label error'>" + $translate.instant(errorMessage) + "</label>");
							if (attrs.id) {
